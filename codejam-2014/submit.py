...
try:
    ...
    if not hasattr(pkg, 'solve_it'):
        print 'the solve_it() function was not found in solver2.py'
        quit()
    solve_it = pkg.solve_it
except ImportError:
    print 'solver2.py was not found in the python path.'
    quit()
...
def output(part):
    ...
    try:
        ...
        print 'the solve_it(input_data) method from solver2.py raised an exception'
        print 'try testing it with python ./solver2.py before running this submission script'
        print 'exception message:'
        print e
        print ''
